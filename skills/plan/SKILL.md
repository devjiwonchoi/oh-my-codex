...
1. Read plan file from `.nomx/plans/`
...
- If optional MCP compatibility tools or Codex consultation are unavailable, fall back to equivalent NOMX prompt/native agents -- never block on external tools
