...
import { nomxLogsDir } from '../utils/paths.js';
...
export const NO_TRACKED_SESSION_MESSAGE = 'No tracked NOMX session is associated with this message.';
export const STATUS_DATA_UNAVAILABLE_MESSAGE = 'Tracked NOMX session found, but status data is unavailable.';
...
function readLatestHistoryEntry(
  ...
  const historyPath = join(nomxLogsDir(projectPath), 'session-history.jsonl');
