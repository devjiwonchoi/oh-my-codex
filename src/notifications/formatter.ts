...
/** NOMX UI chrome: spinner/progress indicator characters */
...
/** NOMX HUD status lines: [NOMX#...] or [NOMX] (unversioned) */
const NOMX_HUD_RE = /\[NOMX[#\]]/;
...
export function parseTmuxTail(raw: string): string {
  ...
  for (const line of raw.split("\n")) {
    ...
    if (NOMX_HUD_RE.test(trimmed)) continue;
