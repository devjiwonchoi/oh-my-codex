...
describe('prompt inventory', () => {
  it('counts prompt surfaces, absolute directives, markers, and duplicate fragments', async () => {
    ...
    try {
      ...
      await mkdir(join(root, 'prompts', 'guidance-fragments'), { recursive: true });
      await writeFile(join(root, 'prompts', 'guidance-fragments', 'core.md'), 'fragment\n');
      ...
      assert.deepEqual(paths, [
        'AGENTS.md',
        'prompts/executor.md',
        'prompts/guidance-fragments/core.md',
