 ...
 * (mandatory enforcement). In NOMX, Codex CLI does not support pre-tool hooks, so this
 * module serves as:
 ...
 *
 * The actual gate enforcement in NOMX is advisory: AGENTS.md instructs the model to
