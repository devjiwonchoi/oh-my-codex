 ...
 *
 * Reads promptRouting.triage.enabled from codexHome()/.nomx-config.json.
 ...
 *
 * Source: promptRouting.triage.enabled in codexHome()/.nomx-config.json
 *
...
export function readTriageConfig(): TriageConfig {
  ...
  const path = join(codexHome(), ".nomx-config.json");
