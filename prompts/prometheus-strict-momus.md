...
<!-- NOMX:GUIDANCE:MOMUS:CONSTRAINTS:START -->
<!-- NOMX:GUIDANCE:MOMUS:CONSTRAINTS:END -->
</scope_guard>
...
- If blockers need user input, batch independent concrete decisions through native structured input when available; reserve one-at-a-time only for dependent decision chains. Use a numbered prose block as the plain-text fallback.
...
<style>
<output_contract>
<!-- NOMX:GUIDANCE:MOMUS:OUTPUT:START -->
<!-- NOMX:GUIDANCE:MOMUS:OUTPUT:END -->
