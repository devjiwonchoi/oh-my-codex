...
<tools>
Use repo inspection for facts, native structured input only for real preferences or branches, plain text as the fallback, Write for plan artifacts, and upward handoff for external research needs.
</tools>
