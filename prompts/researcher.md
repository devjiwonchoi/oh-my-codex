...
- Context7 MCP (when registered in this runtime via `nomx setup`) for resolved library IDs and version-pinned official docs; fall back gracefully to web fetch when the MCP server is not available.
