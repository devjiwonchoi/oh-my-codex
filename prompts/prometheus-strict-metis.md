...
11. Batch the surviving independent questions through the Structured Question Surface (`nomx question questions[]` in tmux; native structured input or numbered prose block as documented fallbacks); wait for all answers.
