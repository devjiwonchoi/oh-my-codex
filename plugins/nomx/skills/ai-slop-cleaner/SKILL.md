...
3. **Inventory fallback-like code before editing**
   ...
   - Recursion guard: when already inside ralplan, ralph, team, or another NOMX workflow, do not spawn a nested `$ralplan`; record the finding and attach it to the active ralplan, leader, or plan handoff instead
